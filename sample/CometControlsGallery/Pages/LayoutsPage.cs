		...
		View body() => GalleryPageHelpers.Scaffold("Layouts",
			...
			Border(
				Grid(
					...
					new object[] { "*", "*" },
					ColorBlock("Top-Left", Colors.Salmon).Cell(0, 0),
					ColorBlock("Top-Right", Colors.SkyBlue).Cell(0, 1),
					ColorBlock("Bottom-Left", Colors.PaleGreen).Cell(1, 0),
					ColorBlock("Bottom-Right", Colors.Plum).Cell(1, 1)
				)
				.RowSpacing(8)
				.ColumnSpacing(8)
			)
			...
			Border(
				VStack((float?)0,
					Text("Styled Border")
						.FontSize(16)
						.FontWeight(FontWeight.Bold),
					Text("Borders can have custom stroke color and thickness.")
						.FontSize(13)
						.Color(Colors.Grey)
				)
			)
