...
namespace Comet
{
	...
	public class FlyoutPage : View, IEnumerable, IContainerView
	{
		View _flyout;
		View _detail;
		Binding<bool> _isPresented;
		Binding<FlyoutBehavior> _flyoutBehavior;
		...
		/// </summary>
		public Binding<bool> IsPresented
		{
			get => _isPresented;
			set => this.SetBindingValue(ref _isPresented, value);
		}
		...
		/// </summary>
		public Binding<FlyoutBehavior> FlyoutLayoutBehavior
		{
			get => _flyoutBehavior;
			set => this.SetBindingValue(ref _flyoutBehavior, value);
		}
