...
namespace Comet
{
	public static partial class CometControls
	{
		...
		public static Image Image(string source) => new Image((Binding<string>)source);
		public static Image Image(Binding<string> source) => new Image(source);
		public static Image Image(Func<string> source) => new Image(source);
		public static Image Image(Binding<IImageSource> imageSource) => new Image(imageSource);
		...
		// Picker
		public static Picker Picker(Binding<int> selectedIndex, params string[] items) => new Picker(selectedIndex, items);
