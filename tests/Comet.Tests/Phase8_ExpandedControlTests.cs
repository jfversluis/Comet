...
namespace Comet.Tests
{
	...
	public class Phase8_GeneratedControlTests : TestBase
	{
		...
		{
			var state = new State<string>("Click");
		...
		{
			var state = new State<double>(0.3);
			var slider = Slider(state, 0, 1);
		...
		{
			var state = new State<string>("Start");
			var text = Text(state);
			Assert.NotNull(text);
