...
namespace Comet.Tests
{
	...
	public class GeneratedControlRegressionTests : TestBase
	{
		...
		{
			var slider = new Slider(50, 0, 100);
		...
		public void DatePicker_CanBeCreated()
		{
			...
			var picker = new DatePicker(date);
		...
		public void TimePicker_CanBeCreated()
		{
			...
			var picker = new TimePicker(time);
			Assert.NotNull(picker);
		...
		{
			var stepper = new Stepper(5, 0, 10, 1);
		...
		public void AllGeneratedControls_InheritFromView()
		{
			...
			Assert.IsAssignableFrom<View>(new Slider(0));
			Assert.IsAssignableFrom<View>(new Toggle(false));
			Assert.IsAssignableFrom<View>(new ProgressBar(0));
			...
			Assert.IsAssignableFrom<View>(new Stepper(0, 0, 1, 1));
		}
	}
}
